    ...
    return (
        <footer className="bg-secondary shadow-xl text-base-content">
            ...
            <div className="bg-primary border-b-5 border-secondary py-4">
                <p className="text-center w-11/12 mx-auto md:text-sm text-[12px] text-muted font-medium">Copyright © {new Date().getFullYear()} - All right reserved by Hurayra Mart</p>
            </div>
        </footer>
    );
};
